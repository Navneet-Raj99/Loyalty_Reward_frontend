  ...
  return (
    <div>
      ...
      <p>
        ...
        of RideEasy's Website, located at RideEasy.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use RideEasy if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing RideEasy, you agreed to use
        cookies in agreement with the RideEasy's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, RideEasy and/or its licensors own the
        intellectual property rights for all material on RideEasy. All
        intellectual property rights are reserved. You may access this from
        RideEasy for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from RideEasy</li>
        <li>Sell, rent or sub-license material from RideEasy</li>
        <li>Reproduce, duplicate or copy material from RideEasy</li>
        <li>Redistribute content from RideEasy</li>
      </ul>
      ...
      <p>
        ...
        RideEasy does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of RideEasy,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, RideEasy shall not be liable
      ...
      <p>
        RideEasy reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant RideEasy a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of RideEasy; and (d) the link is
      ...
      <p>
        ...
        e-mail to RideEasy. Please include your name, your organization name,
      ...
      <p>
        No use of RideEasy's logo or other artwork will be allowed for linking
